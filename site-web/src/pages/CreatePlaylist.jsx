...
export default function CreatePlaylist() {
  ...
  const handleSubmit = async (event) => {
    ...
    // TODO : envoyer la bonne requête pour ajouter ou modifier une playlist en fonction de l'attribut params.id DONE
    if (params.id) {
  ...
  // TODO : Gérer le changement de nom DONE
  ...
  // TODO : Envoyer une requête de supression au serveur et naviguer vers la page principale DONE
    ...
    <main id="main-area" className="flex-row">
      <form className="form-group" id="playlist-form">
        <div id="general-info" className="flex-row">
          <fieldset className="form-control">
            ...
            <div className="form-control flex-row">
              ...
              {/*TODO : lier au nom de la playlist DONE*/}
              <input
                type="text"
                id="name"
            ...
            <div className="form-control flex-row">
              ...
              {/*TODO : lier à la description de la playlist DONE*/}
              <input
                type="text"
                id="description"
        ...
        <fieldset className="form-control">
          ...
          {/*TODO : construire les choix de chansons dans des éléments <option> DONE*/}
        ...
        {/*TODO : afficher "Modifier la playlist" ou "Ajouter la playlist" en fonction de l'état du formulaire DONE*/}
        <input
          type="submit"
