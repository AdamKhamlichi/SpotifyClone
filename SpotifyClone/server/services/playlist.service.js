...
class PlaylistService {
  ...
  /**
   * TODO : Implémenter la récupération de toutes les playlists DONE
   * Retourne toutes les playlists disponibles
   * @returns {Promise<Array>} la liste de toutes les playlists
   */
  async getAllPlaylists () {
    const playlist = await this.collection.find({}).toArray();
    return playlist;
  }

  /**
   * TODO : Implémenter la récupération d'une playlist en fonction de son id DONE
  ...
  /**
   * TODO : Implémenter l'ajout d'une nouvelle playlist DONE
  ...
  /**
   * TODO : Implémenter la mise à jour d'une playlit existante DONE
  ...
  /**
   * TODO : Implémenter la recherche pour les 2 champs des playlists (name et description). DONE
